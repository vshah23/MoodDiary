...
class VSCoreDataManager: NSObject {
    ...
    fileprivate lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: kModelFileName, withExtension: "momd")!
    ...
    fileprivate lazy var persistentStoreCoordinator: NSPersistentStoreCoordinator = {
        ...
        let url = self.applicationDocumentsDirectory.appendingPathComponent(kSQLiteFileName)
    ...
    lazy var mainContext: NSManagedObjectContext = {
        ...
        mainContext.parent = self.rootSavingContext
        mainContext.persistentStoreCoordinator = mainContext.parent?.persistentStoreCoordinator
        ...
        NotificationCenter.default.addObserver(forName: NSNotification.Name.NSManagedObjectContextDidSave,
                                                                ...
                                                                using: { notification in
                                                                    ...
                                                                    for object in updatedObjects {
                                                                        mainContext.object(with: object.objectID).willAccessValue(forKey: nil)
                                                                    }
